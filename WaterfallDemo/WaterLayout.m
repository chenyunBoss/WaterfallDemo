...
- (CGSize)collectionViewContentSize{
    ...
    maxColumnHeight = maxColumnHeight + self.endgeInsets.bottom;
    if (maxColumnHeight <= self.collectionView.frame.size.height) {
        return CGSizeMake(0, self.collectionView.frame.size. height);
    }
